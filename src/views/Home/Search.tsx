    ...
    return <section className="w-full h-280 bg-gray-dark">
        <div className="container mx-auto h-full pt-80 relative">
            ...
            <div className="h-50 w-2/4 bg-white rounded-md flex items-center p-4 mt-10">
                <input value={val} onChange={handleInput} type="text" className="flex-1 h-full appearance-none focus:outline-none focus:ring-2 focus:ring-light-gray focus:border-light-gray pl-20 pr-10 rounded-md" placeholder="Search by Address / Txn Hash / Block / Token / Domain Name" />
